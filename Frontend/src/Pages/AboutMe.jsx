...
const AboutMe = React.forwardRef((props, ref) => {
  ...
  return (
    <div ref={ref} className="flex flex-col items-center justify-center h-auto w-full px-4 py-8 pt-[12vh] sm:px-6 md:px-10 lg:flex-row lg:min-h-screen lg:px-16 md:gap-2 border-5">
        {/*Entire Text Section*/}
